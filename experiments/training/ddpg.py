...
from sarlopt.networks import linear_actor_network as lin_actor_net
...
def train_ddpg(
    ...
    tf_env_training = tf_fun_env.TFFunctionEnv(
        function=function, dims=dims, seed=seed, duration=env_steps
    )
    tf_env_eval = tf_fun_env.TFFunctionEnv(
        function=function, dims=dims, seed=seed, duration=env_eval_steps
    )
    ...
    train_metrics = [tf_metrics.AverageReturnMetric(), tf_metrics.MaxReturnMetric()]
