...
class ReplayBufferState:
    ...
    def __init__(self, replay_buffer: tf_uniform_replay_buffer.TFUniformReplayBuffer):
        self._data_spec = replay_buffer.data_spec

        self._list_trajectories = list(
            replay_buffer.as_dataset(single_deterministic_pass=True).as_numpy_iterator()
        )
    ...
    def num_rewards_close_to(
        self, value: np.ndarray, reward_scale_factor=1.0, ref_l2_norm=1.0
    ):
        num = 0
